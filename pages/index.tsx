                ...
                <div>
                    <AppHeader>
                        <img
                            ...
                            style={{ padding: '0 4px', width: '48px', height: '48px', marginTop: '-4px' }}
                        />
                        <Brand>
                    ...
                    {searchState === 'loaded' && props.search.searchResult
                        ? SearchResult(props.search.searchType, props.search.searchResult)
                        : ''}
