...
abstract class BaseGithubClient {
     ...
     */
    findRepositories = async (text: string, page = 1): Promise<SearchResult<Repository>> => {
     ...
     */
    findUsers = async (text: string, page = 1): Promise<SearchResult<User>> => {
